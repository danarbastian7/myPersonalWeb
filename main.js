// const { Tabs } = require("@chakra-ui/react")
...
const btnop3 = document.getElementById("op3")
const op1Text = document.getElementById("text1")
const op2Text = document.getElementById("text2")
const op3Text = document.getElementById("text3")
